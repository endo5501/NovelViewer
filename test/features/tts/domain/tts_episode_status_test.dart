...
void main() {
  group('TtsEpisodeStatus.fromDb', () {
    test('maps "generating" to TtsEpisodeStatus.generating', () {
      expect(
        TtsEpisodeStatus.fromDb('generating'),
    ...
    test('maps "completed" to TtsEpisodeStatus.completed', () {
      expect(TtsEpisodeStatus.fromDb('completed'), TtsEpisodeStatus.completed);
    });

    test('throws FormatException on unknown string', () {
      expect(
        () => TtsEpisodeStatus.fromDb('invalid'),
  ...
  group('TtsEpisodeStatus.toDb', () {
    test('roundtrips generating', () {
      expect(
        TtsEpisodeStatus.fromDb(TtsEpisodeStatus.generating.toDb()),
        TtsEpisodeStatus.generating,
      );
    });
    ...
    test('roundtrips partial', () {
      expect(
        TtsEpisodeStatus.fromDb(TtsEpisodeStatus.partial.toDb()),
    ...
    test('roundtrips completed', () {
      expect(
        TtsEpisodeStatus.fromDb(TtsEpisodeStatus.completed.toDb()),
