...
void main() {
  group('UI refresh after novel update', () {
    test(
      'refreshNovel completion triggers allNovelsProvider invalidation',
      () async {
        ...
        final container = ProviderContainer(
          overrides: [libraryPathProvider.overrideWithValue('/tmp/test')],
        );
    ...
    test(
      ...
      () async {
        ...
        container.listen(downloadProvider, (previous, next) {
        ...
        expect(container.read(downloadProvider).status, DownloadStatus.idle);
