...
void main() {
  group('BookmarkListPanel', () {
    ...
    testWidgets('jump reconstructs the path from the current folder after a rename '
      ...
      final libraryDir = Directory.systemTemp.createTempSync(
        'bookmark_jump_rename_',
      );
