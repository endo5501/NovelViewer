...
void main() {
  group('VerticalTextPage selection highlight', () {
    ...
    testWidgets('no selection highlight when selection params are null', (
      ...
      await tester.pumpWidget(
        _buildTestWidget(segments: const [PlainTextSegment('あいう')]),
      );
  ...
  group('VerticalTextPage gesture interaction', () {
    ...
    testWidgets('tap calls onSelectionChanged with null', (tester) async {
      ...
      ViewerSelection? notifiedSelection = const ViewerSelection(
        text: 'initial',
        plainTextOffset: 0,
      );
  ...
  group('VerticalTextPage character centering', () {
    testWidgets(
      ...
      (tester) async {
        const fontSize = 14.0;
        await tester.pumpWidget(
          _buildTestWidget(segments: const [PlainTextSegment('あい')]),
        );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpWidget(
          _buildTestWidget(segments: const [PlainTextSegment('あ\n\nい')]),
        );
  ...
  group('VerticalTextPage punctuation rotation', () {
    ...
    testWidgets(
      ...
      (tester) async {
        await tester.pumpWidget(
          _buildTestWidget(segments: const [PlainTextSegment('A:B')]),
        );
    ...
    testWidgets('double quote is rotated and kept as original character', (
      ...
      await tester.pumpWidget(
        _buildTestWidget(segments: const [PlainTextSegment('あ”い')]),
      );
    ...
    testWidgets(
      'rotated cell keeps the same height as a normal character cell',
      (tester) async {
        await tester.pumpWidget(
          _buildTestWidget(segments: const [PlainTextSegment('あ:う')]),
        );
  ...
  group('VerticalTextPage rotation offset/hit-test integrity', () {
    testWidgets('search highlight lands on a rotation-target colon', (
      ...
      await tester.pumpWidget(
        _buildTestWidget(segments: const [PlainTextSegment('あ:う')], query: ':'),
      );
  ...
  group('VerticalTextPage gesture mode classification', () {
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          selectionNotifications.where((t) => t != null),
          isEmpty,
          reason:
    ...
    testWidgets(
      'vertical drag triggers text selection (enters selecting mode)',
      (tester) async {
        final selectionNotifications = <ViewerSelection?>[];
        final swipeNotifications = <SwipeDirection>[];
