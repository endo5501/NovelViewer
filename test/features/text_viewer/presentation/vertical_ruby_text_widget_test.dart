...
Widget _buildTestWidget({required String base, required String rubyText}) {
  return MaterialApp(
...
void main() {
  group('VerticalRubyTextWidget character centering', () {
    testWidgets(
      ...
      (tester) async {
        const fontSize = 14.0;
        await tester.pumpWidget(_buildTestWidget(base: '漢字', rubyText: 'かんじ'));
        ...
        for (final char in ['漢', '字']) {
          ...
          expect(
            ...
            TextAlign.center,
            reason: 'Base char "$char" should have textAlign: TextAlign.center',
          );
      ...
      (tester) async {
        ...
        for (final char in ['か', 'ん', 'じ']) {
          ...
          expect(
            textWidget.textAlign,
            TextAlign.center,
            reason: 'Ruby char "$char" should have textAlign: TextAlign.center',
          );
  ...
  group('VerticalRubyTextWidget vertical character mapping for ruby text', () {
    ...
    testWidgets('ruby text with dash is mapped to vertical equivalent', (
      ...
      await tester.pumpWidget(_buildTestWidget(base: '漢字', rubyText: 'ーかー'));
    ...
    testWidgets('ruby text with punctuation is mapped to vertical equivalent', (
      ...
      await tester.pumpWidget(_buildTestWidget(base: '漢字', rubyText: '。、'));
    ...
    testWidgets(
      ...
      (tester) async {
        await tester.pumpWidget(_buildTestWidget(base: '漢字', rubyText: 'カンジ'));
  ...
  group('VerticalRubyTextWidget punctuation rotation', () {
    testWidgets('rotation-target char in base is rotated via Transform', (
      ...
      await tester.pumpWidget(_buildTestWidget(base: 'A:B', rubyText: 'かな'));
