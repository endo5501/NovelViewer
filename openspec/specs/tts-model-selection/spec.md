...
TTS model size selection capability - allows users to choose between different TTS model sizes (0.6B small/fast and 1.7B large/high-quality), with automatic directory resolution, persistence, and legacy migration support.
