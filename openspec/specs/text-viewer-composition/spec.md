...
Define how the text viewer is decomposed into a shell, a TTS controls bar, and a content renderer, and how these widgets share state via Riverpod rather than through a single god-widget.
