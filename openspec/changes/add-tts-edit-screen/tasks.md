...
- [ ] 5.1 編集画面用Riverpodプロバイダーを設計・実装: セグメントリスト状態、生成中状態、再生中状態の管理
- [ ] 5.2 テキスト編集時のDB書き込みとaudio_data削除のテストを作成
- [ ] 5.3 テキスト編集時のDB書き込みロジックを実装: 編集確定時にレコードなければINSERT、あればUPDATE、既存audio_data削除
