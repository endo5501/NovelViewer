...
- [x] 5.1 iPad 縦向き（narrow レイアウト、ファイルブラウザ非表示）で、左右の画面端からのスワイプでページが送れることを確認する
- [x] 5.2 端でのスワイプが文字選択を誤って開始しないことを確認する
- [x] 5.3 テキストの余白の見た目が変わっていないこと、ページ送りのスライドアニメーションが不自然でないことを確認する
