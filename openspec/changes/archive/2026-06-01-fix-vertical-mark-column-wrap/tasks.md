...
- [x] 3.1 縦書き表示で、桁の折り返し位置にまたがる解析済み単語に傍線・ポップアップが表示されることを確認
- [x] 3.2 折り返しにまたがる単語を選択して再解析し、改行を含まない正しい単語として解析されることを確認
- [x] 3.3 本物の段落改行をまたぐ単語が誤マッチしないこと、横書き表示が従来どおり動作することを確認
