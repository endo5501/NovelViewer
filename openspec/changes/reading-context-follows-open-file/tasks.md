...
- [x] 8.3 design.md の D2 を「作品の解決」と「話一覧のフォルダ」の2本立てに書き直し、D3 を family を使わない形へ差し替え、D11（移動は選択を解除しない）を追加する
...
- [ ] 8.6 現在の状態で code-review と codex のレビューを再実行し、5.1・5.2 を閉じる
