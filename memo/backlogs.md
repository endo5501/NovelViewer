...
- [x] 小説フォルダ削除機能を追加
- [ ] 選択中の小説タイトルを表示する
- [ ] すでにダウンロード済みのファイルは再ダウンロードしないようにする
- [ ] ダークモードの追加
- [ ] 行間調整機能の追加
- [ ] 挿絵生成機能の追加
- [ ] 検索・LLM要約の右辺カラムの非表示
- [ ] 縦書き表示でのスワイプ操作による画面切り替え
- [ ] 起動直後の画面サイズが小さい。画面いっぱいに広がっていてほしい
- [ ] 独自アイコンの設定
...
- [ ] 特定のファイルを縦書き表示すると、左辺カラムにテキストがはみ出る
...
- [ ] なろう小説で複数のページを持つ長編小説はダウンロードできるが、1ページのみの短編小説はダウンロードできない. 
